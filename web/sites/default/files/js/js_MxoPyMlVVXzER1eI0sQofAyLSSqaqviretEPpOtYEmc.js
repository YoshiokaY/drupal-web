...
function setHtml(dataList, el) {
  ...
  if (dataList === null) {
    ...
    dataList.forEach(function (element) {
      ...
      html += "</dt>";
      html += "<dd>".concat(element.attributes.title, "<br></dd>");
      html += "</div>";
    });
  }
  // HTMLに出力
