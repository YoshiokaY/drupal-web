...
/***/ "./src/_assets/js/utils/access.js":
/*!****************************************!*\
  !*** ./src/_assets/js/utils/access.js ***!
  \****************************************/
...
var Main = /*#__PURE__*/function () {
  function Main() {
    ...
    // scroll icon
    var scrollItem = [].slice.call(document.getElementsByClassName("table_type_scroll"));
    var _loop = function _loop(i) {
      scrollItem[i].addEventListener("scroll", function (elm) {
    ...
    // change tab
    this.tabBtn = [].slice.call(document.getElementsByClassName("tabButton__item"));
    this.tabItem = [].slice.call(document.getElementsByClassName("tabContent"));
    for (var _i = 0; _i < this.tabBtn.length; _i++) {
      this.tabBtn[_i].addEventListener("click", function (e) {
        if (!e.target.classList.contains("is-active")) {
          var cat = e.srcElement.id;

          // change active
          for (var c = 0; c < _this.tabBtn.length; c++) {
            _this.tabBtn[c].classList.remove("is-active");
          }
          e.target.classList.add("is-active");

          // change show contents
          for (var _c = 0; _c < _this.tabItem.length; _c++) {
            _this.tabItem[_c].setAttribute("hidden", "");
          }
          if (cat === "tab1") {
            _this.hideTab01();
          } else if (cat === "tab2") {
...
$(window).on("load", function () {
  ...
  var accBtn = [].slice.call(document.getElementsByClassName("js-accBtn"));
  var accContents = [].slice.call(document.getElementsByClassName("js-accCon"));
  var _loop = function _loop(i) {
    accBtn[i].addEventListener("click", function (e) {
      ...
      if (!accBtn[i].classList.contains("isActive")) {
        ...
        accContents[i].style.height = accContents[i].scrollHeight + space + "px";
...
/***/ "./src/_assets/js/utils/animation.js":
/*!*******************************************!*\
  !*** ./src/_assets/js/utils/animation.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var boxes = document.querySelectorAll(".scrollIn,.scroll,.typTxt");
...
var topFixedSearchBtnFlagMv = false;
var topFixedSearchBtnFlagSearch = false;
if (document.getElementById("taoyaSearch")) {
  ...
  var fixedSearchBtn = document.getElementsByClassName("bgContainer")[0];
  fixedSearchBtnObserbe(fixedSearchBtn);
}
function fixedSearchBtnObserbe(elm) {
  var thresholdSets = [];
  for (var _i = 0; _i <= 1.0; _i += 0.01) {
    thresholdSets.push(_i);
  }
  var obs = new IntersectionObserver(onIntersectOrderShow.bind(this), {
    threshold: thresholdSets
  });
  obs.observe(elm);
}
function fixedSearchBtnObserbeTop(elm) {
  var obs = new IntersectionObserver(onIntersectOrderShowTop.bind(this));
  obs.observe(elm);
}
function onIntersectOrderShow(elm) {
  if (elm[0].intersectionRatio * 100 >= 7) {
    document.getElementsByClassName("fixed-search-btn")[0].classList.add("isShow");
  } else {
    document.getElementsByClassName("fixed-search-btn")[0].classList.remove("isShow");
  }
}
...
document.addEventListener("DOMContentLoaded", function () {
  if (typeof api !== "undefined") $.ajax({
    type: "GET",
    url: api + "?recommendFlg=1&sortkey=2&sortby=1&externalSiteAuthKey=" + externalSiteAuthKey + "&facilityId=" + facilityId + "&langCd=ja",
    dataType: "json"
  }).done(function (data) {
    ...
    for (var i = 0; i < planLength; i++) {
      ...
      // HTMLを生成
      sHtml += "<a href=" + planData.detailUrl + ' class="plan_box" target="_blank">';
      sHtml += '<div class="plan_img"><img src="' + planImage + '" class=""></div>';
      sHtml += '<div class="plan_content"><div class="content_inner">';
      sHtml += '<div class="plan_name_wrapper">';
      if (planData.custom.tag) sHtml += '<p class="plan_tag">' + planData.custom.tag + "</p>";
      sHtml += '<p class="plan_name">' + planData.name + "</p></div>\n";
      if (planSpecialPlan) {
        //スペシャルプラン
        sHtml += '<p class="plan_price"><span class="special">' + planSpecialPlan + "</span></p>";
      } else if (planRegularPrice && planPrice) {
        //通常価格あり
        sHtml += '<p class="plan_price"><span class="regular">通常価格<span class="red">' + String(planRegularPrice).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + ' 円</span></span><span class="arrow">→</span><span class="red">' + String(planPrice).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + ' 円～</span><br class="sp"><span>大人お1人様(税込)</span></p>';
      } else if (planPrice) {
        //プラン価格のみ
        sHtml += '<p class="plan_price"><span>大人お1人様(税込)</span><span class="red">' + String(planPrice).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + " 円～</span></p>";
      }
      sHtml += '<p class="plan_period"><span class="plan_period_ttl">宿泊期間：</span>' + String(planData.stayPeriodStartDate).replace(/-/g, "/") + "～" + String(planData.stayPeriodEndDate).replace(/-/g, "/") + "</p>\n";
      sHtml += "</div></div>";
    ...
    var slidesToShowNum = 4; //slidesToShowに設定したい値を挿入
    /* slidesToShowより投稿が少ない場合の処理▽ */
    var item = $(".plan_box").length; //liの個数を取得
    if (item <= slidesToShowNum) {
      for (var i = 0; i <= slidesToShowNum + 1 - item; i++) {
        //足りていない要素数分、後ろに複製
        $(".plan_box:nth-child(" + i + ")").clone().appendTo(".plan_boxes");
      }
    }
    $("#taoyaPickup .plan_boxes").on("init reInit afterChange", function (event, slick, currentSlide, nextSlide) {
      var i = (currentSlide ? currentSlide : 0) + 1;
      $(".slick-num .nowcnt").text(i);
      $(".slick-num .allcnt").text(slick.slideCount);
    });
    $("#taoyaPickup .plan_boxes").not(".slick-initialized").slick({
      autoplay: true,
      autoplaySpeed: 4000,
      speed: 2000,
      infinite: true,
...
var Main = /*#__PURE__*/function () {
  function Main() {
    var _this = this;
    _classCallCheck(this, Main);
    if (!document.getElementById("js-youtubePc") && !document.getElementById("js-youtubeSp")) {
      return false;
    }
    ...
    window.addEventListener("resize", function () {
      if (window.innerWidth >= 751) {
        _this.playerPc.playVideo();
        _this.playerSp.stopVideo();
        document.getElementById("js-youtubePc").style.opacity = "1";
        document.getElementById("js-youtubeSp").style.opacity = "0";
      } else {
        _this.playerSp.playVideo();
        _this.playerPc.stopVideo();
        document.getElementById("js-youtubePc").style.opacity = "0";
        document.getElementById("js-youtubeSp").style.opacity = "1";
      }
    });
...
$(function () {
  for (var i = 0; i < $(".onsenSlideMain").length; i++) {
    $(".onsenSlideMain.slider" + i).not(".slick-initialized").slick({
      autoplay: true,
      autoplaySpeed: 4000,
      speed: 800,
      infinite: true,
    ...
    $(".onsenSlideThumb.slider" + i).not(".slick-initialized").slick({
...
$(function () {
  $(".onsenSlideThreeColm").not(".slick-initialized").on("init", function (event, slick) {
    $(this).append('<div class="slick-num"><span class="now"></span><span class="delimiter"></span><span class="all"></span></div>');
...
$(function () {
  $(".onsenSlideOneColmList").not(".slick-initialized").on("init", function (event, slick) {
    $(this).append('<div class="slick-num"><span class="now"></span><span class="delimiter"></span><span class="all"></span></div>');
    $(".now").text(slick.currentSlide + 1);
    $(".all").text(slick.slideCount);
  }).slick({
...
$(function () {
  $("#onsen01 .onsenSlideMain").not(".slick-initialized").slick({
    autoplay: true,
    autoplaySpeed: 4000,
    speed: 800,
    infinite: true,
  ...
  var slidesToShowNum = 8; //slidesToShowに設定したい値を挿入
  var item = $("#onsen01 .onsenSlideThumb li").length;
  if (item >= slidesToShowNum) {
...
$(function () {
  $("#onsen02 .onsenSlideMain").not(".slick-initialized").slick({
    autoplay: true,
    autoplaySpeed: 4000,
    speed: 800,
    infinite: true,
  ...
  var slidesToShowNum = 8; //slidesToShowに設定したい値を挿入
  var item = $("#onsen02 .onsenSlideThumb li").length;
  if (item >= slidesToShowNum) {
    slidesToShowNum = item;
  }
...
$(function () {
  $("#onsen03 .onsenSlideMain").not(".slick-initialized").slick({
    autoplay: true,
    autoplaySpeed: 4000,
    speed: 800,
    infinite: true,
  ...
  var slidesToShowNum = 8; //slidesToShowに設定したい値を挿入
  var item = $("#onsen03 .onsenSlideThumb li").length;
  if (item >= slidesToShowNum) {
    slidesToShowNum = item;
  }
...
$("#onsenAmenity .amenitySlide").not(".slick-initialized").slick({
  autoplay: false,
  infinite: false,
  arrows: false,
  dots: false,
...
$(function () {
  ...
  $(".banner_cards_slide").not(".slick-initialized").slick({
    autoplay: true,
    autoplaySpeed: 3000,
    speed: 1000,
    infinite: true,
...
$(function () {
  for (var i = 0; i < $(".c_time_slides").length; i++) {
    $(".c_time_slides.slide" + i).not(".slick-initialized").slick({
      autoplay: false,
      speed: 800,
      infinite: true,
      arrows: true,
...
window.addEventListener("load", function () {
  ...
  $("html").css({
    "scroll-padding-top": headerHight
  });
...
/* harmony import */ var _utils_slide__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/slide */ "./src/_assets/js/utils/slide.js");
...
/* harmony import */ var _utils_animation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/animation */ "./src/_assets/js/utils/animation.js");
...
/* harmony import */ var _utils_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/api */ "./src/_assets/js/utils/api.js");
/* harmony import */ var _utils_movie__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/movie */ "./src/_assets/js/utils/movie.js");
/* harmony import */ var _utils_access__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/access */ "./src/_assets/js/utils/access.js");
...
object_fit_images__WEBPACK_IMPORTED_MODULE_9___default()("img.objectFit");
$(function () {
  $(".slideContainer .plan_name ").matchHeight();
});
}();
/******/ })()
;
