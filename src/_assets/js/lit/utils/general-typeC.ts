...
@customElement("general-typec")
export class GeneralTypeC extends LitElement {
  static styles = css`
    .planBox {
      padding-top: 0;
    }
  ...
  render() {
    return html` <style>
      ...
      >
        <div class="inner">
          <h3 class="-color01">花水木</h3>
          <figure class="planImage">
            <img
              src="/wp_2021/wp-content/uploads/general_img003b.jpg"
              srcset="
                /wp_2021/wp-content/uploads/general_img003b.jpg 1x,
                /wp_2021/wp-content/uploads/general_img003b.jpg 2x
              "
              alt="花水木"
              width="560"
              height="373"
            ...
            <div class="planIcon">
              ...
              ${ww > 750 || this.open === true
                ? html`
                    ...
                    <figure>
                      <img
                        src="/wp_2021/wp-content/uploads/plan_icon60.svg"
                        alt="骨上げマイクロバス"
                        width="134"
                        height="134"
                        loading="lazy"
                    ...
                    <figure>
                      <img
                        src="/wp_2021/wp-content/uploads/plan_icon59.svg"
                        alt="法要室使用料"
                        width="134"
                        height="134"
                        loading="lazy"
