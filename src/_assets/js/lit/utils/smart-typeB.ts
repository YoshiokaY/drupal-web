...
@customElement("smart-typeb")
export class SmartTypeB extends LitElement {
  static styles = css`
    .planBox {
      padding-top: 0;
    }
  ...
  render() {
    return html` <style>
      ...
      >
        <div class="inner">
          <h3 class="-color01">サルビア</h3>
          <figure class="planImage">
            <img
              src="/wp_2021/wp-content/uploads/family_img002.jpg"
              srcset="
                /wp_2021/wp-content/uploads/family_img002.jpg 1x,
                /wp_2021/wp-content/uploads/family_img002.jpg 2x
              "
              alt="サルビア"
              width="560"
              height="373"
