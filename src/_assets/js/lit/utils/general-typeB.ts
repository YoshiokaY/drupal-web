...
@customElement("general-typeb")
export class GeneralTypeB extends LitElement {
  static styles = css`
    .planBox {
      padding-top: 0;
    }
  ...
  render() {
    return html` <style>
      ...
      >
        <div class="inner">
          <h3 class="-color01">白百合</h3>
          <figure class="planImage">
            <img
              src="/wp_2021/wp-content/uploads/general_img002b.jpg"
              srcset="
                /wp_2021/wp-content/uploads/general_img002b.jpg 1x,
                /wp_2021/wp-content/uploads/general_img002b.jpg 2x
              "
              alt="白百合"
              width="560"
              height="373"
